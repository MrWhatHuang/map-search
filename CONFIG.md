...
| 变量名              | 用途             | 默认值                             | 说明                                              |
| ------------------- | ---------------- | ---------------------------------- | ------------------------------------------------- |
| `VITE_AMAP_KEY`     | 前端高德地图 Key | `ee0eeaabf7b9b44be3ed8c0e37aa1d89` | **Web 端（JS API）类型**，用于加载高德地图 JS API |
| `VITE_API_BASE_URL` | 前端 API 地址    | `http://localhost:3000`            | 后端 API 服务地址                                 |
| `AMAP_KEY`          | 后端高德地图 Key | `ee0eeaabf7b9b44be3ed8c0e37aa1d89` | **Web 服务类型**，用于后端调用高德 REST API       |
